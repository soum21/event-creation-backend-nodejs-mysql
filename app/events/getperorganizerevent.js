...
//Get All Events per Organizer
app.get('/:organizer_id/allEvents', async (req, res) => {
    //Query Tables: Event_Category,Event,Event_Media,Venue,Venue_Address,TicketInventory,Price

    let organizer_eventDetails = await db.sequelize.query(
        `Select em.id,em.event_name,em.event_desc,em.organizer_id,
        ...
        tp.quota,tp.event_id,tp.price_id,tp.ticket_type,
        ...
        tp.sales_closeTime
            ...
            join (select 
                t.quota,t.event_id,t.price_id,t.ticket_type,
                t.sales_openDate,t.sales_openTime,t.sales_closeDate,
                t.sales_closeTime,
                p.price
                from price as p
                join ticket_inventory as t
